...
while True:
    ...
    segment, address = s.recvfrom(packet_size)
    frame_byte = segment
    ...
    if frame_recover is None:
        frame_byte = b''
        continue
    cv2.putText(frame_recover, str(len(frame_byte)), (10, 10), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
    cv2.putText(frame_recover, str(fps), (10, 20), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
